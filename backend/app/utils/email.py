...
# ✅ FIXED LINK: Verification Email (Design Same as you provided)
async def send_verification_email(to_email: str, token: str):
    
    # FIX: Link ko sahi API route par point kiya
    # Pehle ye verify-email par ja raha tha, ab ye /api/auth/verify-email par jayega
...
# ✅ IMPROVED: Professional Broadcast / Announcement Email
def send_generic_email(to_email: str, subject: str, body: str):
    """
    Improved Design for Admin Announcements.
    Matches the branding of Notification emails.
    """
    ...
    <body>
        <div class="email-container">
            ...
            <div class="footer">
                ...
                <p style="margin-top: 5px;">You received this email because you are a registered user.</p>
            </div>
        </div>
    </body>
    </html>
