...
export default function ChatAssistant({ theme, isDarkMode }) {
    ...
    }, [messages, isOpen, isTyping]); // isTyping add kiya taaki load hote hi scroll ho
    ...
    return (
        <>
            <AnimatePresence>
                {isOpen && (
                    <motion.div 
                        ...
                        // ✅ FIX: h-[100dvh] ensures it fits exact viewport even with keyboard open
                        // Flex-col ensures header stays top, input stays bottom
                    ...
                    >
                        ...
                        <form onSubmit={handleSend} className={`shrink-0 p-3 border-t flex gap-2 pb-safe md:pb-3 ${
                            ...
                            <input 
                                ...
                                // ✅ UPDATED: Lighter Border Logic here
            ...
            {/* --- FLOATING TRIGGER BUTTON (Square) --- */}
            <motion.button 
